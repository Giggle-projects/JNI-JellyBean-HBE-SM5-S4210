...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        while (second > 0) {
            ...
            printDotMatrix(value, 20);
            second--;
        }
    }

    private void printDotMatrix(String value, int speed) {
        ...
        for(int asciiInt : asciis) {
            ...
            asciiInt -= 0x20;
            for (int j = 0; j < 5; j++) {
                String font = Integer.toHexString((this.font[asciiInt][j]));
                if (font.length() < 2){
                    result += "0";
                }
                result += font;
        ...
        for (int i = 0; i < (result.length() - 18) / 2; i++) {
    ...
    public native String dotMatrixControl(String data);
