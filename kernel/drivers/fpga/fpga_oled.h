...
#define DRIVER_DESC		"oled test program" 

#define OLED_NAME		"fpga_oled"	 
#define OLED_MODULE_VERSION	"OLED PORT V0.1" 
#define OLED_ADDRESS		0x050000c0	 
#define OLED_ADDRESS_RANGE	0x1000		 

// OLED Interface
#define CS_OLED         	0x1000          
#define RESETPIN_OLED   	0x800
#define D_C             	0x400
#define WN_OLED         	0x200           
#define RN_OLED         	0x100           
...
static unsigned short *oled_ioremap;
